...
-- Clients
INSERT INTO CLIENTS (USER_ID, COMPANY_NAME, INDUSTRY, TIMEZONE, LAST_INTERACTION)
SELECT user_id, 'Acme Corp', 'Technology', 'EST', SYSDATE
...
SELECT m.meeting_id, u.user_id, 'attended'
FROM MEETINGS m
CROSS JOIN USERS u
