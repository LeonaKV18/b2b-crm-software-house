...
CREATE TABLE users (
    ...
    email VARCHAR2(255) NOT NULL UNIQUE CHECK (email LIKE '%_@__%.__%'),
...
CREATE TABLE proposals (
    ...
    actual_hours NUMBER,
    value NUMBER,
    status VARCHAR2(50) CHECK (status IN ('draft', 'submitted', 'approved', 'rejected', 'active', 'in_progress', 'completed')),
    admin_comments CLOB,
...
CREATE TABLE meetings (
    ...
    status VARCHAR2(50) CHECK (status IN ('scheduled', 'ongoing', 'completed')),
